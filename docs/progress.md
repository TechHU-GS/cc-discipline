...
- **Shipped**: **v2.13.2**, published to npm and rolled out. Three releases in one pass — 2.13.0 retired `/finish` and `/retro` and added `/coplan`; 2.13.1 and 2.13.2 fixed two CRLF defects that the rollout itself exposed. See the four 2026-08-28 milestones below.
